...
int reminderDuration = 60000; // Once exercise begins it reminds them they should be tilting after this much of a delay
...
// 1 = Success Sound
// 2 = Its time to tilt (Tier 1)
// 3 = Its time to tilt (Tier 2)
// 4 = Its time to tilt (tier 3)
// 5 = Reminder to tilt 1 min into the window time
        ...
        if (active) {
            ...
            if (waitingForExercise) {
                if (millis() - waitingStartTime >= reminderDuration) {
                    // Play speaker file number 5 here to remind them
                }
